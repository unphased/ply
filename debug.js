...
var DEBUG = (function($) {
    ...
    var git_context = "#% 2ce6d8d a major refactor of ply functionality here... there is a radical change with assert (now intentionally a global variable, in order to support dynamic script-injected debuggability) and i have taken out the touchinspector bits so that I can work on that separately from the low level event layer that is ply %#";
